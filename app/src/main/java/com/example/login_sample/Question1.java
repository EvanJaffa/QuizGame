    ...
    private void createAnswerConfirmationA(){
        ...
        confirmDlg.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent wrongAnsIntent = new Intent(Question1.this, WrongAnswer.class);
    ...
    private void createAnswerConfirmationB(){
        ...
        confirmDlg.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intentQ2 = new Intent(Question1.this, Question2.class);
                //intentQ2.putExtra("currentMoney", 100);
